...
\subsection*{Zmiany w złożoności pamięciowej!!!}
Dla pierwszego rzędu $B_k$ musimy zaalokować miejsce na aż do $3l$ elementów, natomiast w pozostałych miejscach potrzebujemy $2l+1$ elementów. Jest to spowodowane tym, że gdy zamieniamy wiersze i wykonujemy eliminację gaussa, to potrzebujemy aktualizować, także te "zerowe" elementy.
Nie ma to jednak wpływu na złożoność pamięciową, która dalej pozostaje $O(n \cdot l)$.
